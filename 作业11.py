...
plot(x_M1,y_M1,color='green')
scatter(0,0,s=1,color='red')
title(r'$\beta=2.0$',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
...
subplot(222)
plot(x_M2,y_M2,color='green')
scatter(0,0,s=1,color='red')
title(r'$\beta=2.01$',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
...
subplot(223)
plot(x_M3,y_M3,color='green')
scatter(0,0,s=1,color='red')
title(r'$\beta=2.1$',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
...
subplot(224)
plot(x_M4,y_M4,color='green')
scatter(0,0,s=1,color='red')
title(r'$\beta=2.5$',fontsize=15)
xlabel('x/AU')
xlim(-0.6,0.6)
ylabel('y/AU')
ylim(-0.6,0.6)
